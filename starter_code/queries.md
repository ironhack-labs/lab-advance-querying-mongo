...
db.companies.find( { $and: [ {price_amount: {$gt: 100}}, {founded_year: {$lte: 2010}} ] } )
...
db.companies.find({founded_month: {$gte: 4, $lte: 6}})

### 12. All the companies that have been 'deadpooled' after the third year.
<!-- Not working -->

db.companies.find({ $where: deadpooled_year - founded_year > 3});
