...
`db.companies.find({$and: [{'ipo.valuation_amount': {$gt: 10000000}}, {'founded_year': {$lt: 2010}}]}, {_id: 0, name: 1, ipo: 1})`
...
`db.companies.find({$and: [{'founded_year': {$lt: 2000}}, {'acquisition.price_amount': {$ne: null}}, {'acquisition.price_amount': {$gt: 10000000}}]})`
...
`db.companies.find({$and:[{'acquisition.price_amount': {$ne: null}}, {'founded_day': {$lte: 7}}]}).sort({'acquisition.price_amount': -1}).limit(10)`
