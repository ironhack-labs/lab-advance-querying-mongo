...
db.companies.find({"ipo.valuation_amount": { $gt: 100000000}, founded_year: { $lt: 2010}}, {name: 1, founded_year: 1})
...
db.companies.find({number_of_employees: { $gt: 100}, number_of_employees: { $lt: 1000}}, {name: 1, number_of_employees: 1})
...
db.companies.find({founded_month: {$gte: 10}}).limit(1000)

### 12. All the companies founded before 2000 that have an acquisition amount of more than 10.000.000

db.companies.find({founded_year: {$lt: 2000}, "acquisition.price_amount": {$lt: 10000000}})
...
db.companies.find({founded_month: {$lte: 3}},{name: 1, acquisition: 1, _id: 0 }).sort({acquisition: -1}).limit(10)
