...
<!-- don't include means it is null or does not exist? -->
...
filter: { $and: [{"acquisition.acquired_year": {$gt: 2010}}, {"acquisitions.price_amount": {$gt: 10000000}}]}
project: {name: 1, "acquisitions.price_amount": 1, _id: 0}
