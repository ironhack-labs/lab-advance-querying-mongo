...
field: {number_of_employees: {$gt: 100, $lt: 1000}}
...
field: {founded_year: {$lt: 2000}, 'acquisition.price_amount': {$gt: 10000000} }
...
field: {category_code: 'web', number_of_employees: {$gt: 4000}}
sort: {number_of_employees: 1}
