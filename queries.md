...
query:      { founded_month: { $gte: 3, $lte: 7} }
projection: //
sort:       //
skip:       //
limit:      1000
...
query:      { "acquisition.acquired_month": { $gte: 1 }, "acquisition.acquired_month": { $lt: 4 } }
projection: { name: 1, acquisition: 1, _id: 0 }
sort:       //
skip:       //
limit:      10
...
query:      { founded_year: { $gte: 2000 }, founded_year: { $lte: 2010 }, $or : [ { acquisition: { $eq: null } }, { "acquisition.acquired_year": { $gte: 2011 } } ] }
projection: //
sort:       //
skip:       //
limit:      //