...
query: {$and: [{"acquisition.acquired_day": {$lte: 7}}, {"acquisition.acquired_day": {$ne: null}}] }
sort: {"acquisition.price_amount": -1}
limit: 10

### 16. All the companies on the 'web' `category` that have more than 4000 employees. Sort them by the amount of employees in ascending order.

query: {$and: [{number_of_employees: {$gt: 4000}}, {category_code: {$in: ["web"]}}] }
sort: {number_of_employees: 1}
...
query: {$and: [{"acquisition.acquired_month": {$lte: 4}}, {"acquisition.acquired_month": {$ne: null}} ] }
